...
jQuery( window ).load(function() {
	...
	if (jQuery(".animated-bg").length) {
		jQuery(".animated-bg").each(function() {
	        var elem = jQuery(this).find(".using-bg-color"),
	        color_arr = ["#1fa67a", "#33c362", "#f48d39", "#ff545a", "#654e9c", "#0eb6bc"];
	        elem.css("background-color", "#0eb6bc");
	       setInterval(function() {        	
	            var color = color_arr.shift();
